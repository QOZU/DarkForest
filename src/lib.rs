...
#[derive(Debug)]
pub struct DarkForestProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DarkForestProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DarkForest processing");
    
    let mut processor = DarkForestProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DarkForestProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DarkForestProcessor::new(false);
